...
class CassandraClient:
    ...
    def create_course(self, course_data: Dict[str, Any], teacher_id: str, teacher_name: str,
        ...
        """
        Crée un nouveau cours à partir d'un dictionnaire
        
        Args:
            course_data: Dictionnaire avec 'title' et 'description'
            teacher_id: ID de l'enseignant
            teacher_name: Nom de l'enseignant
            file_url: URL du fichier dans MinIO
            file_name: Nom du fichier
            file_size: Taille du fichier en octets
            content_type: Type MIME du fichier
            
        Returns:
            Dict: Les métadonnées du cours créé
        """
